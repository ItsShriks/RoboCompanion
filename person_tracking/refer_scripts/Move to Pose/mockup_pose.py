...
class EstimatePose(ScenarioStateBase):
    ...
    def execute(self, userdata):
        ...
        self.detected_pose=userdata.lever_mock_pose


        self.pose = PoseStamped()
        self.pose.header.frame_id = self.frame_id
        self.pose.pose.position.x = self.detected_pose[0]
        self.pose.pose.position.y = self.detected_pose[1]
        self.pose.pose.position.z = self.detected_pose[2]
        self.pose.pose.orientation.x = self.detected_pose[3]
        self.pose.pose.orientation.y = self.detected_pose[4]
        self.pose.pose.orientation.z = self.detected_pose[5]
        self.pose.pose.orientation.w = self.detected_pose[6]
